...
#ifndef RTW_HEADER_heli_q8_d2p2_h_
#define RTW_HEADER_heli_q8_d2p2_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_d2p2_COMMON_INCLUDES_
# define heli_q8_d2p2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d2p2_COMMON_INCLUDES_ */

#include "heli_q8_d2p2_types.h"
...
#define heli_q8_d2p2_rtModel           RT_MODEL_heli_q8_d2p2_T
...
#define rtB                            heli_q8_d2p2_B
#define BlockIO                        B_heli_q8_d2p2_T
#define rtX                            heli_q8_d2p2_X
#define ContinuousStates               X_heli_q8_d2p2_T
#define rtXdot                         heli_q8_d2p2_XDot
#define StateDerivatives               XDot_heli_q8_d2p2_T
#define tXdis                          heli_q8_d2p2_XDis
#define StateDisabled                  XDis_heli_q8_d2p2_T
#define rtP                            heli_q8_d2p2_P
#define Parameters                     P_heli_q8_d2p2_T
#define rtDWork                        heli_q8_d2p2_DW
#define D_Work                         DW_heli_q8_d2p2_T

/* Parameters (auto storage) */
struct P_heli_q8_d2p2_T_ {
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Constant2_Value;              /* Expression: 0.095
...
extern P_heli_q8_d2p2_T heli_q8_d2p2_P;

/* Block signals (auto storage) */
extern B_heli_q8_d2p2_T heli_q8_d2p2_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d2p2_T heli_q8_d2p2_X;

/* Block states (auto storage) */
extern DW_heli_q8_d2p2_T heli_q8_d2p2_DW;
...
extern void heli_q8_d2p2_initialize(void);
extern void heli_q8_d2p2_output0(void);
extern void heli_q8_d2p2_update0(void);
extern void heli_q8_d2p2_output(int_T tid);
extern void heli_q8_d2p2_update(int_T tid);
extern void heli_q8_d2p2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d2p2_rtModel *heli_q8_d2p2(void);
...
extern RT_MODEL_heli_q8_d2p2_T *const heli_q8_d2p2_M;
 ...
 *
 * '<Root>' : 'heli_q8_d2p2'
 * '<S1>'   : 'heli_q8_d2p2/Conversion'
 * '<S2>'   : 'heli_q8_d2p2/Heli 3D'
 * '<S3>'   : 'heli_q8_d2p2/Joystick'
 * '<S4>'   : 'heli_q8_d2p2/Pitch & Elevation Controller'
 * '<S5>'   : 'heli_q8_d2p2/Pitch & Elevation Controller/Pitch & Elevation controller'
 * '<S6>'   : 'heli_q8_d2p2/Pitch & Elevation Controller/Pitch & Elevation controller/Elevation controller'
 * '<S7>'   : 'heli_q8_d2p2/Pitch & Elevation Controller/Pitch & Elevation controller/Pitch PD-controller'
 * '<S8>'   : 'heli_q8_d2p2/Pitch & Elevation Controller/Pitch & Elevation controller/Elevation controller/Elevation controller'
 */
#endif                                 /* RTW_HEADER_heli_q8_d2p2_h_ */
