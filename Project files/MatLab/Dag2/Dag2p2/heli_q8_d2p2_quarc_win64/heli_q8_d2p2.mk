...
MODEL                = heli_q8_d2p2
MODULES              = heli_q8_d2p2_data.c heli_q8_d2p2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_d2p2.mk
...
MODELLIB                  = heli_q8_d2p2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_d2p2_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\jahnpn\Desktop\LINSYS~1\PROJEC~1\MatLab\Dag2\Dag2p2
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_d2p2_quarc_win64
