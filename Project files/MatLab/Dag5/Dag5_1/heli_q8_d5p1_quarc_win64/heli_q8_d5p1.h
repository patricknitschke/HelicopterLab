...
#ifndef RTW_HEADER_heli_q8_d5p1_h_
#define RTW_HEADER_heli_q8_d5p1_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_d5p1_COMMON_INCLUDES_
# define heli_q8_d5p1_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d5p1_COMMON_INCLUDES_ */

#include "heli_q8_d5p1_types.h"
...
#define heli_q8_d5p1_rtModel           RT_MODEL_heli_q8_d5p1_T
...
#define rtB                            heli_q8_d5p1_B
#define BlockIO                        B_heli_q8_d5p1_T
#define rtX                            heli_q8_d5p1_X
#define ContinuousStates               X_heli_q8_d5p1_T
#define rtXdot                         heli_q8_d5p1_XDot
#define StateDerivatives               XDot_heli_q8_d5p1_T
#define tXdis                          heli_q8_d5p1_XDis
#define StateDisabled                  XDis_heli_q8_d5p1_T
#define rtP                            heli_q8_d5p1_P
#define Parameters                     P_heli_q8_d5p1_T
#define rtDWork                        heli_q8_d5p1_DW
#define D_Work                         DW_heli_q8_d5p1_T

/* Parameters (auto storage) */
struct P_heli_q8_d5p1_T_ {
  ...
  real_T Gain1_Gain[9];                /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                        ...
                                        */
  real_T Constant2_Value_i;            /* Expression: 0.095
...
extern P_heli_q8_d5p1_T heli_q8_d5p1_P;

/* Block signals (auto storage) */
extern B_heli_q8_d5p1_T heli_q8_d5p1_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d5p1_T heli_q8_d5p1_X;

/* Block states (auto storage) */
extern DW_heli_q8_d5p1_T heli_q8_d5p1_DW;
...
extern void heli_q8_d5p1_initialize(void);
extern void heli_q8_d5p1_output0(void);
extern void heli_q8_d5p1_update0(void);
extern void heli_q8_d5p1_output(int_T tid);
extern void heli_q8_d5p1_update(int_T tid);
extern void heli_q8_d5p1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d5p1_rtModel *heli_q8_d5p1(void);
...
extern RT_MODEL_heli_q8_d5p1_T *const heli_q8_d5p1_M;
 ...
 *
 * '<Root>' : 'heli_q8_d5p1'
 * '<S1>'   : 'heli_q8_d5p1/Conversion'
 * '<S2>'   : 'heli_q8_d5p1/Heli 3D'
 * '<S3>'   : 'heli_q8_d5p1/IMU System'
 * '<S4>'   : 'heli_q8_d5p1/Joystick1'
 * '<S5>'   : 'heli_q8_d5p1/Pitch & Elevation Controller'
 * '<S6>'   : 'heli_q8_d5p1/Scope system'
 * '<S7>'   : 'heli_q8_d5p1/IMU System/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S8>'   : 'heli_q8_d5p1/IMU System/IMU'
 * '<S9>'   : 'heli_q8_d5p1/IMU System/p, e from IMU'
 * '<S10>'  : 'heli_q8_d5p1/Pitch & Elevation Controller/LQR'
 */
#endif                                 /* RTW_HEADER_heli_q8_d5p1_h_ */
