...
#ifndef RTW_HEADER_heli_q8_d5p3_old_h_
#define RTW_HEADER_heli_q8_d5p3_old_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_d5p3_old_COMMON_INCLUDES_
# define heli_q8_d5p3_old_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d5p3_old_COMMON_INCLUDES_ */

#include "heli_q8_d5p3_old_types.h"
...
#define heli_q8_d5p3_old_rtModel       RT_MODEL_heli_q8_d5p3_old_T
...
typedef struct {
  ...
  real_T A_d[36];                      /* '<S5>/A_d' */
  real_T B_d[12];                      /* '<S5>/B_d' */
  real_T Q_d[36];                      /* '<S5>/Q_d' */
  ...
  real_T UnitDelay2[36];               /* '<S5>/Unit Delay2' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } lambda_PWORK;                      /* '<S5>/lambda' */

  struct {
    void *LoggedData[2];
  } lambdadot_PWORK;                   /* '<S5>/lambdadot' */
  ...
  struct {
    void *LoggedData[2];
  } edot_PWORK_f;                      /* '<S7>/edot' */

  struct {
    void *LoggedData[2];
  } lambdadot_PWORK_o;                 /* '<S7>/lambdadot' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } noisetofile_IWORK;                 /* '<Root>/noise to file' */

  uint8_T StreamCall1_State;           /* '<S9>/Stream Call1' */
} DW_heli_q8_d5p3_old_T;
...
#define rtB                            heli_q8_d5p3_old_B
#define BlockIO                        B_heli_q8_d5p3_old_T
#define rtX                            heli_q8_d5p3_old_X
#define ContinuousStates               X_heli_q8_d5p3_old_T
#define rtXdot                         heli_q8_d5p3_old_XDot
#define StateDerivatives               XDot_heli_q8_d5p3_old_T
#define tXdis                          heli_q8_d5p3_old_XDis
#define StateDisabled                  XDis_heli_q8_d5p3_old_T
#define rtP                            heli_q8_d5p3_old_P
#define Parameters                     P_heli_q8_d5p3_old_T
#define rtDWork                        heli_q8_d5p3_old_DW
#define D_Work                         DW_heli_q8_d5p3_old_T

/* Parameters (auto storage) */
struct P_heli_q8_d5p3_old_T_ {
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Constant2_Value_b;            /* Expression: 0.095
  ...
  real_T Constant_Value;               /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_f;            /* Expression: 65
  ...
  real_T Gain1_Gain[9];                /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                        ...
                                        */
  real_T V_s0_Value[2];                /* Expression: [V_s0, V_d0]
...
struct tag_RTM_heli_q8_d5p3_old_T {
  const char_T *path;
...
extern P_heli_q8_d5p3_old_T heli_q8_d5p3_old_P;

/* Block signals (auto storage) */
extern B_heli_q8_d5p3_old_T heli_q8_d5p3_old_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d5p3_old_T heli_q8_d5p3_old_X;

/* Block states (auto storage) */
extern DW_heli_q8_d5p3_old_T heli_q8_d5p3_old_DW;
...
extern void heli_q8_d5p3_old_initialize(void);
extern void heli_q8_d5p3_old_output0(void);
extern void heli_q8_d5p3_old_update0(void);
extern void heli_q8_d5p3_old_output(int_T tid);
extern void heli_q8_d5p3_old_update(int_T tid);
extern void heli_q8_d5p3_old_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d5p3_old_rtModel *heli_q8_d5p3_old(void);
...
extern RT_MODEL_heli_q8_d5p3_old_T *const heli_q8_d5p3_old_M;
 ...
 *
 * '<Root>' : 'heli_q8_d5p3_old'
 * '<S1>'   : 'heli_q8_d5p3_old/Conversion'
 * '<S2>'   : 'heli_q8_d5p3_old/Heli 3D'
 * '<S3>'   : 'heli_q8_d5p3_old/IMU System'
 * '<S4>'   : 'heli_q8_d5p3_old/Joystick1'
 * '<S5>'   : 'heli_q8_d5p3_old/Kalman filter'
 * '<S6>'   : 'heli_q8_d5p3_old/Pitch & Elevation Controller'
 * '<S7>'   : 'heli_q8_d5p3_old/Scope system'
 * '<S8>'   : 'heli_q8_d5p3_old/IMU System/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S9>'   : 'heli_q8_d5p3_old/IMU System/IMU'
 * '<S10>'  : 'heli_q8_d5p3_old/IMU System/p, e from IMU'
 * '<S11>'  : 'heli_q8_d5p3_old/Kalman filter/Kalman prediction step'
 * '<S12>'  : 'heli_q8_d5p3_old/Pitch & Elevation Controller/LQR'
 */
#endif                                 /* RTW_HEADER_heli_q8_d5p3_old_h_ */
