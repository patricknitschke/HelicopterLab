...
#ifndef RTW_HEADER_heli_q8_d5p2_h_
#define RTW_HEADER_heli_q8_d5p2_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_d5p2_COMMON_INCLUDES_
# define heli_q8_d5p2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d5p2_COMMON_INCLUDES_ */

#include "heli_q8_d5p2_types.h"
...
#define heli_q8_d5p2_rtModel           RT_MODEL_heli_q8_d5p2_T
...
typedef struct {
  ...
  real_T V_s0[2];                      /* '<Root>/V_s0' */
  real_T Sum1_d[2];                    /* '<Root>/Sum1' */
...
#define rtB                            heli_q8_d5p2_B
#define BlockIO                        B_heli_q8_d5p2_T
#define rtX                            heli_q8_d5p2_X
#define ContinuousStates               X_heli_q8_d5p2_T
#define rtXdot                         heli_q8_d5p2_XDot
#define StateDerivatives               XDot_heli_q8_d5p2_T
#define tXdis                          heli_q8_d5p2_XDis
#define StateDisabled                  XDis_heli_q8_d5p2_T
#define rtP                            heli_q8_d5p2_P
#define Parameters                     P_heli_q8_d5p2_T
#define rtDWork                        heli_q8_d5p2_DW
#define D_Work                         DW_heli_q8_d5p2_T

/* Parameters (auto storage) */
struct P_heli_q8_d5p2_T_ {
...
extern P_heli_q8_d5p2_T heli_q8_d5p2_P;

/* Block signals (auto storage) */
extern B_heli_q8_d5p2_T heli_q8_d5p2_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d5p2_T heli_q8_d5p2_X;

/* Block states (auto storage) */
extern DW_heli_q8_d5p2_T heli_q8_d5p2_DW;
...
extern void heli_q8_d5p2_initialize(void);
extern void heli_q8_d5p2_output0(void);
extern void heli_q8_d5p2_update0(void);
extern void heli_q8_d5p2_output(int_T tid);
extern void heli_q8_d5p2_update(int_T tid);
extern void heli_q8_d5p2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d5p2_rtModel *heli_q8_d5p2(void);
...
extern RT_MODEL_heli_q8_d5p2_T *const heli_q8_d5p2_M;
 ...
 *
 * '<Root>' : 'heli_q8_d5p2'
 * '<S1>'   : 'heli_q8_d5p2/Conversion'
 * '<S2>'   : 'heli_q8_d5p2/Estimator'
 * '<S3>'   : 'heli_q8_d5p2/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S4>'   : 'heli_q8_d5p2/Heli 3D'
 * '<S5>'   : 'heli_q8_d5p2/IMU'
 * '<S6>'   : 'heli_q8_d5p2/Integral effect'
 * '<S7>'   : 'heli_q8_d5p2/Joystick'
 * '<S8>'   : 'heli_q8_d5p2/Pitch & Elevator controller'
 * '<S9>'   : 'heli_q8_d5p2/Subsystem'
 * '<S10>'  : 'heli_q8_d5p2/Pitch & Elevator controller/Pitch PD-controller'
 */
#endif                                 /* RTW_HEADER_heli_q8_d5p2_h_ */
