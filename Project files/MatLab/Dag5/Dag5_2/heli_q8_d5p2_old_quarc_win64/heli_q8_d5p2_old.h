...
#ifndef RTW_HEADER_heli_q8_d5p2_old_h_
#define RTW_HEADER_heli_q8_d5p2_old_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_d5p2_old_COMMON_INCLUDES_
# define heli_q8_d5p2_old_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d5p2_old_COMMON_INCLUDES_ */

#include "heli_q8_d5p2_old_types.h"
...
#define heli_q8_d5p2_old_rtModel       RT_MODEL_heli_q8_d5p2_old_T
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } lambdadot_PWORK_l;                 /* '<S5>/lambdadot' */
...
#define rtB                            heli_q8_d5p2_old_B
#define BlockIO                        B_heli_q8_d5p2_old_T
#define rtX                            heli_q8_d5p2_old_X
#define ContinuousStates               X_heli_q8_d5p2_old_T
#define rtXdot                         heli_q8_d5p2_old_XDot
#define StateDerivatives               XDot_heli_q8_d5p2_old_T
#define tXdis                          heli_q8_d5p2_old_XDis
#define StateDisabled                  XDis_heli_q8_d5p2_old_T
#define rtP                            heli_q8_d5p2_old_P
#define Parameters                     P_heli_q8_d5p2_old_T
#define rtDWork                        heli_q8_d5p2_old_DW
#define D_Work                         DW_heli_q8_d5p2_old_T

/* Parameters (auto storage) */
struct P_heli_q8_d5p2_old_T_ {
  ...
  boolean_T HILInitialize_set_clock_params_;/* Mask Parameter: HILInitialize_set_clock_params_
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_clock_param_p;/* Mask Parameter: HILInitialize_set_clock_param_p
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_h;/* Mask Parameter: HILInitialize_set_digital_out_h
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_fa;/* Mask Parameter: HILInitialize_set_digital_ou_fa
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_outputs_i;/* Mask Parameter: HILInitialize_set_pwm_outputs_i
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_pwm_output_fy;/* Mask Parameter: HILInitialize_set_pwm_output_fy
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  real_T BackmotorSaturation_LowerSat; /* Expression: -5
                                        * Referenced by: '<S2>/Back motor: Saturation'
                                        */
  real_T UnitDelay_InitialCondition_h[6];/* Expression: [0;0;-0.53;0;0;0]
...
struct tag_RTM_heli_q8_d5p2_old_T {
  const char_T *path;
...
extern P_heli_q8_d5p2_old_T heli_q8_d5p2_old_P;

/* Block signals (auto storage) */
extern B_heli_q8_d5p2_old_T heli_q8_d5p2_old_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d5p2_old_T heli_q8_d5p2_old_X;

/* Block states (auto storage) */
extern DW_heli_q8_d5p2_old_T heli_q8_d5p2_old_DW;
...
extern void heli_q8_d5p2_old_initialize(void);
extern void heli_q8_d5p2_old_output0(void);
extern void heli_q8_d5p2_old_update0(void);
extern void heli_q8_d5p2_old_output(int_T tid);
extern void heli_q8_d5p2_old_update(int_T tid);
extern void heli_q8_d5p2_old_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d5p2_old_rtModel *heli_q8_d5p2_old(void);
...
extern RT_MODEL_heli_q8_d5p2_old_T *const heli_q8_d5p2_old_M;
 ...
 *
 * '<Root>' : 'heli_q8_d5p2_old'
 * '<S1>'   : 'heli_q8_d5p2_old/Conversion'
 * '<S2>'   : 'heli_q8_d5p2_old/Heli 3D'
 * '<S3>'   : 'heli_q8_d5p2_old/IMU System'
 * '<S4>'   : 'heli_q8_d5p2_old/Joystick1'
 * '<S5>'   : 'heli_q8_d5p2_old/Kalman filter'
 * '<S6>'   : 'heli_q8_d5p2_old/Pitch & Elevation Controller'
 * '<S7>'   : 'heli_q8_d5p2_old/Scope system'
 * '<S8>'   : 'heli_q8_d5p2_old/IMU System/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S9>'   : 'heli_q8_d5p2_old/IMU System/IMU'
 * '<S10>'  : 'heli_q8_d5p2_old/IMU System/p, e from IMU'
 * '<S11>'  : 'heli_q8_d5p2_old/Kalman filter/Kalman prediction step'
 * '<S12>'  : 'heli_q8_d5p2_old/Pitch & Elevation Controller/LQR'
 */
#endif                                 /* RTW_HEADER_heli_q8_d5p2_old_h_ */
