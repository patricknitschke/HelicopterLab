 ...
 * '<S2>'   : 'heli_q8_d6p3/Estimator'
 * '<S3>'   : 'heli_q8_d6p3/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S4>'   : 'heli_q8_d6p3/Heli 3D'
 * '<S5>'   : 'heli_q8_d6p3/IMU'
 * '<S6>'   : 'heli_q8_d6p3/Joystick'
 * '<S7>'   : 'heli_q8_d6p3/Pitch and elevation controller'
 * '<S8>'   : 'heli_q8_d6p3/Subsystem'
 * '<S9>'   : 'heli_q8_d6p3/Pitch and elevation controller/Augment system'
 * '<S10>'  : 'heli_q8_d6p3/Pitch and elevation controller/Pitch & Elevation controller'
 * '<S11>'  : 'heli_q8_d6p3/Pitch and elevation controller/Augment system/Integral effect'
 * '<S12>'  : 'heli_q8_d6p3/Pitch and elevation controller/Pitch & Elevation controller/Pitch PD-controller'
 */
