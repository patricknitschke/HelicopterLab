  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p3_P.UnitDelay_InitialCondition
	  ...
	  ;% heli_q8_d6p3_P._CurrentSetting
	  section.data(1).logicalSrcIdx = 120;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p3_P._CurrentSetting_a
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p3_B.TrigonometricFunction1
	  section.data(19).logicalSrcIdx = 18;
	  ...
	  section.data(29).dtTransOffset = 206;
	
	  ;% heli_q8_d6p3_B.Sum2_k
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 207;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p3_DW.UnitDelay_DSTATE
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% heli_q8_d6p3_DW.Estimatedstate_PWORK.FilePtr
	  ...
	  ;% heli_q8_d6p3_DW.lambda_PWORK.LoggedData
	  ...
	  ;% heli_q8_d6p3_DW.y_IMU_PWORK.FilePtr
	  ...
	  ;% heli_q8_d6p3_DW.u_PWORK.LoggedData
	  section.data(21).logicalSrcIdx = 37;
	  section.data(21).dtTransOffset = 26;
	
	  ;% heli_q8_d6p3_DW.pdot1_PWORK.LoggedData
	  ...
	  ;% heli_q8_d6p3_DW.Estimatedstate_IWORK.Count
	  section.data(1).logicalSrcIdx = 47;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p3_DW.y_IMU_IWORK.Count
  ...
  targMap.checksum0 = 4073760419;
  targMap.checksum1 = 48061876;
  targMap.checksum2 = 2857659216;
  targMap.checksum3 = 745453510;
