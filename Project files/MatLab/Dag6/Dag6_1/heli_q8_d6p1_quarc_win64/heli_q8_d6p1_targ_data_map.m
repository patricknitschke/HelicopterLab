  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p1_P.Constant2_Value_b
	  ...
	  ;% heli_q8_d6p1_P.Constant1_Value_j
	  ...
	  ;% heli_q8_d6p1_P.UnitDelay2_InitialCondition
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p1_B.R_d
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 114;
	  ...
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 178;
	  ...
	  ;% heli_q8_d6p1_B.Sum1_e
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 230;
	
	  ;% heli_q8_d6p1_B.FrontmotorSaturation
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 232;
	
	  ;% heli_q8_d6p1_B.BackmotorSaturation
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 233;
	
	  ;% heli_q8_d6p1_B.GameController_o4
	  section.data(27).logicalSrcIdx = 26;
	  section.data(27).dtTransOffset = 234;
	
	  ;% heli_q8_d6p1_B.GameController_o5
	  section.data(28).logicalSrcIdx = 27;
	  section.data(28).dtTransOffset = 235;
	
	  ;% heli_q8_d6p1_B.Sum3
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 236;
	
	  ;% heli_q8_d6p1_B.x_bar_k2
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 238;
	
	  ;% heli_q8_d6p1_B.P_bar_k2
	  section.data(31).logicalSrcIdx = 30;
	  section.data(31).dtTransOffset = 244;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p1_DW.UnitDelay2_DSTATE
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 6;
	  ...
	  ;% heli_q8_d6p1_DW.e_PWORK_n.LoggedData
	  section.data(7).logicalSrcIdx = 23;
	  section.data(7).dtTransOffset = 12;
	
	  ;% heli_q8_d6p1_DW.edot_PWORK_f.LoggedData
	  section.data(8).logicalSrcIdx = 24;
	  section.data(8).dtTransOffset = 14;
	
	  ;% heli_q8_d6p1_DW.lambdadot_PWORK_o.LoggedData
	  section.data(9).logicalSrcIdx = 25;
	  section.data(9).dtTransOffset = 16;
	
	  ;% heli_q8_d6p1_DW.p_PWORK_g.LoggedData
	  section.data(10).logicalSrcIdx = 26;
	  section.data(10).dtTransOffset = 18;
	
	  ;% heli_q8_d6p1_DW.pdot_PWORK_i.LoggedData
	  section.data(11).logicalSrcIdx = 27;
	  section.data(11).dtTransOffset = 20;
	
	  ;% heli_q8_d6p1_DW.noisetofile_PWORK.FilePtr
	  ...
	  ;% heli_q8_d6p1_DW.noisetofile_IWORK.Count
  ...
  targMap.checksum0 = 4213526756;
  targMap.checksum1 = 2973812698;
  targMap.checksum2 = 1708822838;
  targMap.checksum3 = 3273544708;
