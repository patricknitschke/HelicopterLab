...
MODEL                = heli_q8_d6p1
MODULES              = heli_q8_d6p1_data.c heli_q8_d6p1_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_d6p1.mk
...
MODELLIB                  = heli_q8_d6p1lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_d6p1_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\jahnpn\Desktop\LINSYS~1\PROJEC~1\MatLab\Dag6\Dag6_1
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_d6p1_quarc_win64
