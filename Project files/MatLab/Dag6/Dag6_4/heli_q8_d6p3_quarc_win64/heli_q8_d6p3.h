...
#ifndef RTW_HEADER_heli_q8_d6p3_h_
#define RTW_HEADER_heli_q8_d6p3_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_d6p3_COMMON_INCLUDES_
# define heli_q8_d6p3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d6p3_COMMON_INCLUDES_ */

#include "heli_q8_d6p3_types.h"
...
#define heli_q8_d6p3_rtModel           RT_MODEL_heli_q8_d6p3_T
...
typedef struct {
  real_T UnitDelay1[6];                /* '<S11>/Unit Delay1' */
  real_T A_d[36];                      /* '<S11>/A_d' */
  real_T B_d[12];                      /* '<S11>/B_d' */
  real_T C_d[30];                      /* '<S11>/C_d' */
  real_T R_d[25];                      /* '<S11>/R_d' */
  real_T Q_d[36];                      /* '<S11>/Q_d' */
  ...
  boolean_T StreamRead1_o3;            /* '<S9>/Stream Read1' */
} B_heli_q8_d6p3_T;
...
#define rtB                            heli_q8_d6p3_B
#define BlockIO                        B_heli_q8_d6p3_T
#define rtX                            heli_q8_d6p3_X
#define ContinuousStates               X_heli_q8_d6p3_T
#define rtXdot                         heli_q8_d6p3_XDot
#define StateDerivatives               XDot_heli_q8_d6p3_T
#define tXdis                          heli_q8_d6p3_XDis
#define StateDisabled                  XDis_heli_q8_d6p3_T
#define rtP                            heli_q8_d6p3_P
#define Parameters                     P_heli_q8_d6p3_T
#define rtDWork                        heli_q8_d6p3_DW
#define D_Work                         DW_heli_q8_d6p3_T

/* Parameters (auto storage) */
struct P_heli_q8_d6p3_T_ {
  ...
  real_T Gain2_Gain[9];                /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                        ...
                                        */
  real_T Constant2_Value_o;            /* Expression: -0.095
...
extern P_heli_q8_d6p3_T heli_q8_d6p3_P;

/* Block signals (auto storage) */
extern B_heli_q8_d6p3_T heli_q8_d6p3_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d6p3_T heli_q8_d6p3_X;

/* Block states (auto storage) */
extern DW_heli_q8_d6p3_T heli_q8_d6p3_DW;
...
extern void heli_q8_d6p3_initialize(void);
extern void heli_q8_d6p3_output0(void);
extern void heli_q8_d6p3_update0(void);
extern void heli_q8_d6p3_output(int_T tid);
extern void heli_q8_d6p3_update(int_T tid);
extern void heli_q8_d6p3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d6p3_rtModel *heli_q8_d6p3(void);
...
extern RT_MODEL_heli_q8_d6p3_T *const heli_q8_d6p3_M;
 ...
 *
 * '<Root>' : 'heli_q8_d6p3'
 * '<S1>'   : 'heli_q8_d6p3/Conversion'
 * '<S2>'   : 'heli_q8_d6p3/Heli 3D'
 * '<S3>'   : 'heli_q8_d6p3/IMU System'
 * '<S4>'   : 'heli_q8_d6p3/Joystick1'
 * '<S5>'   : 'heli_q8_d6p3/Kalman filter'
 * '<S6>'   : 'heli_q8_d6p3/Pitch & Elevation Controller'
 * '<S7>'   : 'heli_q8_d6p3/Scope system'
 * '<S8>'   : 'heli_q8_d6p3/IMU System/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S9>'   : 'heli_q8_d6p3/IMU System/IMU'
 * '<S10>'  : 'heli_q8_d6p3/IMU System/p, e from IMU'
 * '<S11>'  : 'heli_q8_d6p3/Kalman filter/Kalman prediction & correction'
 * '<S12>'  : 'heli_q8_d6p3/Kalman filter/Scope system 2'
 * '<S13>'  : 'heli_q8_d6p3/Kalman filter/x -> y'
 * '<S14>'  : 'heli_q8_d6p3/Kalman filter/Kalman prediction & correction/Kalman prediction step'
 * '<S15>'  : 'heli_q8_d6p3/Kalman filter/Scope system 2/x -> y'
 * '<S16>'  : 'heli_q8_d6p3/Pitch & Elevation Controller/LQR'
 */
#endif                                 /* RTW_HEADER_heli_q8_d6p3_h_ */
