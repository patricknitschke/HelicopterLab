  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q8_d6p5_P.HILInitialize_analog_input_maxi
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 155;
	
	  ;% heli_q8_d6p5_P.HILInitialize_analog_input_mini
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 156;
	
	  ;% heli_q8_d6p5_P.HILInitialize_analog_output_max
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 157;
	
	  ;% heli_q8_d6p5_P.HILInitialize_analog_output_min
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 158;
	
	  ;% heli_q8_d6p5_P.HILInitialize_final_analog_outp
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 159;
	
	  ;% heli_q8_d6p5_P.HILInitialize_final_pwm_outputs
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 160;
	
	  ;% heli_q8_d6p5_P.HILInitialize_initial_analog_ou
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 161;
	
	  ;% heli_q8_d6p5_P.HILInitialize_initial_pwm_outpu
	  ...
	  ;% heli_q8_d6p5_P.HILInitialize_pwm_trailing_dead
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 165;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_other_outputs
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 166;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_other_outpu_m
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 167;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_other_outpu_k
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 168;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_other_outpu_j
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 169;
	
	  ;% heli_q8_d6p5_P.HILInitialize_watchdog_analog_o
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 170;
	
	  ;% heli_q8_d6p5_P.HILInitialize_watchdog_pwm_outp
	  ...
	  ;% heli_q8_d6p5_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 26;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_P.HILInitialize_hardware_clocks
	  ...
	  ;% heli_q8_d6p5_P.HILInitialize_pwm_alignment
	  section.data(4).logicalSrcIdx = 29;
	  section.data(4).dtTransOffset = 5;
	
	  ;% heli_q8_d6p5_P.HILInitialize_pwm_configuration
	  section.data(5).logicalSrcIdx = 30;
	  section.data(5).dtTransOffset = 6;
	
	  ;% heli_q8_d6p5_P.HILInitialize_pwm_modes
	  section.data(6).logicalSrcIdx = 31;
	  section.data(6).dtTransOffset = 7;
	
	  ;% heli_q8_d6p5_P.HILInitialize_pwm_polarity
	  section.data(7).logicalSrcIdx = 32;
	  section.data(7).dtTransOffset = 8;
	
	  ;% heli_q8_d6p5_P.HILInitialize_watchdog_digital_
	  ...
	  ;% heli_q8_d6p5_P.HILInitialize_analog_input_chan
	  ...
	  ;% heli_q8_d6p5_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 36;
	  section.data(3).dtTransOffset = 16;
	
	  ;% heli_q8_d6p5_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 37;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_q8_d6p5_P.HILInitialize_encoder_channels
	  ...
	  ;% heli_q8_d6p5_P.HILInitialize_quadrature
	  ...
	  ;% heli_q8_d6p5_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 42;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 43;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_d6p5_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 44;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_input_
	  section.data(4).logicalSrcIdx = 45;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_inpu_m
	  section.data(5).logicalSrcIdx = 46;
	  section.data(5).dtTransOffset = 4;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_output
	  section.data(6).logicalSrcIdx = 47;
	  section.data(6).dtTransOffset = 5;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_outp_b
	  section.data(7).logicalSrcIdx = 48;
	  section.data(7).dtTransOffset = 6;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_outp_e
	  section.data(8).logicalSrcIdx = 49;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_outp_j
	  section.data(9).logicalSrcIdx = 50;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_outp_c
	  section.data(10).logicalSrcIdx = 51;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 52;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 53;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 54;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 55;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 56;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 57;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 58;
	  section.data(17).dtTransOffset = 16;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 59;
	  section.data(18).dtTransOffset = 17;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 60;
	  section.data(19).dtTransOffset = 18;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 61;
	  section.data(20).dtTransOffset = 19;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 62;
	  section.data(21).dtTransOffset = 20;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 63;
	  section.data(22).dtTransOffset = 21;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 64;
	  section.data(23).dtTransOffset = 22;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_encoder_count
	  section.data(24).logicalSrcIdx = 65;
	  section.data(24).dtTransOffset = 23;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_encoder_cou_k
	  section.data(25).logicalSrcIdx = 66;
	  section.data(25).dtTransOffset = 24;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_encoder_param
	  section.data(26).logicalSrcIdx = 67;
	  section.data(26).dtTransOffset = 25;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_encoder_par_m
	  section.data(27).logicalSrcIdx = 68;
	  section.data(27).dtTransOffset = 26;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 69;
	  section.data(28).dtTransOffset = 27;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_outputs_a
	  section.data(29).logicalSrcIdx = 70;
	  section.data(29).dtTransOffset = 28;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_outputs_g
	  section.data(30).logicalSrcIdx = 71;
	  section.data(30).dtTransOffset = 29;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_outputs_p
	  section.data(31).logicalSrcIdx = 72;
	  section.data(31).dtTransOffset = 30;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 73;
	  section.data(32).dtTransOffset = 31;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 74;
	  section.data(33).dtTransOffset = 32;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_params_at
	  section.data(34).logicalSrcIdx = 75;
	  section.data(34).dtTransOffset = 33;
	
	  ;% heli_q8_d6p5_P.HILInitialize_set_pwm_params__f
	  ...
	  ;% heli_q8_d6p5_P.Enable_now_Value
	  section.data(1).logicalSrcIdx = 77;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_P.Constant2_Value
	  section.data(2).logicalSrcIdx = 78;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_d6p5_P.UnitDelay1_InitialCondition
	  section.data(3).logicalSrcIdx = 79;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_d6p5_P.Provideinitialcond_InitialCondi
	  section.data(4).logicalSrcIdx = 80;
	  section.data(4).dtTransOffset = 8;
	
	  ;% heli_q8_d6p5_P.UnitDelay2_InitialCondition
	  ...
	  ;% heli_q8_d6p5_P.GameController_BufferSize
	  ...
	  ;% heli_q8_d6p5_P.StringConstant_Value
	  section.data(1).logicalSrcIdx = 121;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_P.StreamCall1_URI
	  ...
	  ;% heli_q8_d6p5_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 125;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_P.StreamCall1_Active
	  section.data(2).logicalSrcIdx = 126;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_d6p5_P.HILWriteAnalog_Active
	  section.data(3).logicalSrcIdx = 127;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_d6p5_P.GameController_AutoCenter
	  section.data(4).logicalSrcIdx = 128;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_q8_d6p5_P.GameController_Enabled
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (heli_q8_d6p5_B)
    ;%
      section.nData     = 27;
      section.data(27)  = dumData; %prealloc
      
	  ;% heli_q8_d6p5_B.Gain2
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% heli_q8_d6p5_B.TrigonometricFunction
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 7;
	
	  ;% heli_q8_d6p5_B.RateTransitionx
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 8;
	  ...
	  ;% heli_q8_d6p5_B.RateTransitiony
	  section.data(9).logicalSrcIdx = 8;
	  ...
	  ;% heli_q8_d6p5_B.PitchTransferFcn
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 12;
	
	  ;% heli_q8_d6p5_B.ElevationTransferFcn
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 13;
	
	  ;% heli_q8_d6p5_B.TravelTransferFcn
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 14;
	
	  ;% heli_q8_d6p5_B.Switch
	  section.data(14).logicalSrcIdx = 13;
	  ...
	  ;% heli_q8_d6p5_B.GameController_o4
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 18;
	
	  ;% heli_q8_d6p5_B.GameController_o5
	  section.data(18).logicalSrcIdx = 17;
	  ...
	  ;% heli_q8_d6p5_B.Sum1_e
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 26;
	
	  ;% heli_q8_d6p5_B.Sum3_k
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 28;
	
	  ;% heli_q8_d6p5_B.x_bar_k2
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 30;
	
	  ;% heli_q8_d6p5_B.x_hat_k1
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 36;
	
	  ;% heli_q8_d6p5_B.P_bar_k2
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 42;
	
	  ;% heli_q8_d6p5_B.euler_rates
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (heli_q8_d6p5_DW)
    ;%
      section.nData     = 15;
      section.data(15)  = dumData; %prealloc
      
	  ;% heli_q8_d6p5_DW.UnitDelay1_DSTATE
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_DW.Provideinitialcond_DSTATE
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 6;
	
	  ;% heli_q8_d6p5_DW.UnitDelay2_DSTATE
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 8;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_AIMinimums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 44;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_AIMaximums
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 52;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_AOMinimums
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 60;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_AOMaximums
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 68;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_AOVoltages
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 76;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_FilterFrequency
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 84;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_POSortedFreqs
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 92;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_POValues
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 100;
	
	  ;% heli_q8_d6p5_DW.RateTransitionx_Buffer0
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 108;
	
	  ;% heli_q8_d6p5_DW.RateTransitiony_Buffer0
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 109;
	
	  ;% heli_q8_d6p5_DW.Memory_PreviousInput
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 110;
	
	  ;% heli_q8_d6p5_DW.HILWriteAnalog_Buffer
	  section.data(15).logicalSrcIdx = 14;
	  ...
	  ;% heli_q8_d6p5_DW.e_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 19;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_DW.edot_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 20;
	  section.data(2).dtTransOffset = 2;
	
	  ;% heli_q8_d6p5_DW.lambdadot_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 21;
	  section.data(3).dtTransOffset = 4;
	
	  ;% heli_q8_d6p5_DW.p_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 22;
	  section.data(4).dtTransOffset = 6;
	
	  ;% heli_q8_d6p5_DW.pdot_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 23;
	  section.data(5).dtTransOffset = 8;
	
	  ;% heli_q8_d6p5_DW.Vs_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 24;
	  section.data(6).dtTransOffset = 10;
	
	  ;% heli_q8_d6p5_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 25;
	  section.data(7).dtTransOffset = 11;
	
	  ;% heli_q8_d6p5_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 26;
	  section.data(8).dtTransOffset = 12;
	
	  ;% heli_q8_d6p5_DW.PitchScoperad_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 27;
	  section.data(9).dtTransOffset = 13;
	
	  ;% heli_q8_d6p5_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 28;
	  section.data(10).dtTransOffset = 14;
	
	  ;% heli_q8_d6p5_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 29;
	  section.data(11).dtTransOffset = 15;
	
	  ;% heli_q8_d6p5_DW.TravelScoperad_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 30;
	  section.data(12).dtTransOffset = 16;
	
	  ;% heli_q8_d6p5_DW.HILWriteAnalog_PWORK
	  section.data(13).logicalSrcIdx = 31;
	  section.data(13).dtTransOffset = 17;
	
	  ;% heli_q8_d6p5_DW.Connected_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 32;
	  section.data(14).dtTransOffset = 18;
	
	  ;% heli_q8_d6p5_DW.x_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 33;
	  section.data(15).dtTransOffset = 19;
	
	  ;% heli_q8_d6p5_DW.y_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 34;
	  section.data(16).dtTransOffset = 20;
	
	  ;% heli_q8_d6p5_DW.z_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 35;
	  section.data(17).dtTransOffset = 21;
	
	  ;% heli_q8_d6p5_DW.XScope_PWORK.LoggedData
	  section.data(18).logicalSrcIdx = 36;
	  section.data(18).dtTransOffset = 22;
	
	  ;% heli_q8_d6p5_DW.YScope_PWORK.LoggedData
	  section.data(19).logicalSrcIdx = 37;
	  section.data(19).dtTransOffset = 23;
	
	  ;% heli_q8_d6p5_DW.e_PWORK_i.LoggedData
	  section.data(20).logicalSrcIdx = 38;
	  section.data(20).dtTransOffset = 24;
	
	  ;% heli_q8_d6p5_DW.e_dot_PWORK.LoggedData
	  section.data(21).logicalSrcIdx = 39;
	  section.data(21).dtTransOffset = 26;
	
	  ;% heli_q8_d6p5_DW.lambda_dot_PWORK.LoggedData
	  section.data(22).logicalSrcIdx = 40;
	  section.data(22).dtTransOffset = 28;
	
	  ;% heli_q8_d6p5_DW.p_PWORK_g.LoggedData
	  section.data(23).logicalSrcIdx = 41;
	  section.data(23).dtTransOffset = 30;
	
	  ;% heli_q8_d6p5_DW.p_dot_PWORK.LoggedData
	  section.data(24).logicalSrcIdx = 42;
	  section.data(24).dtTransOffset = 32;
	
	  ;% heli_q8_d6p5_DW.ToFile_PWORK.FilePtr
	  section.data(25).logicalSrcIdx = 43;
	  section.data(25).dtTransOffset = 34;
	
	  ;% heli_q8_d6p5_DW.ToFile1_PWORK.FilePtr
	  section.data(26).logicalSrcIdx = 44;
	  section.data(26).dtTransOffset = 35;
	
	  ;% heli_q8_d6p5_DW.ToWorkspace_PWORK.LoggedData
	  ...
	  ;% heli_q8_d6p5_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 46;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 47;
	  section.data(2).dtTransOffset = 3;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 48;
	  section.data(3).dtTransOffset = 11;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 49;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 50;
	  section.data(5).dtTransOffset = 27;
	
	  ;% heli_q8_d6p5_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 51;
	  section.data(6).dtTransOffset = 35;
	
	  ;% heli_q8_d6p5_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% heli_q8_d6p5_DW.HILInitialize_POSortedChans
	  ...
	  ;% heli_q8_d6p5_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 54;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_DW.ToFile1_IWORK.Count
	  ...
	  ;% heli_q8_d6p5_DW.Kalmanfilter_SubsysRanBC
	  ...
	  ;% heli_q8_d6p5_DW.StreamCall1_State
	  ...
	  ;% heli_q8_d6p5_DW.Kalmanfilter_MODE
	  section.data(1).logicalSrcIdx = 59;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_d6p5_DW.PitchElevationController_MODE
  ...
  targMap.checksum0 = 2635934938;
  targMap.checksum1 = 2361613546;
  targMap.checksum2 = 636252762;
  targMap.checksum3 = 3806466203;
