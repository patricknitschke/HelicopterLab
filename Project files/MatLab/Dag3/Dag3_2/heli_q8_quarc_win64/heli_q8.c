 ...
 * C source code generated on : Tue Oct 01 15:41:44 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum2 = heli_q8_P.ElevationCounttorad_Gain *
      rtb_HILReadEncoderTimebase_o3 + heli_q8_P.Constant1_Value;
  }
   ...
   */
  for (i = 0; i < 2; i++) {
    heli_q8_B.Sum3[i] = heli_q8_B.Fr[i] - ((heli_q8_P.K[i + 2] *
      heli_q8_B.PitchTransferFcn + heli_q8_P.K[i] * heli_q8_B.Sum1) +
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2547024638U);
  heli_q8_M->Sizes.checksums[1] = (1548765481U);
  heli_q8_M->Sizes.checksums[2] = (781163830U);
  heli_q8_M->Sizes.checksums[3] = (1578702203U);
  ...
  heli_q8_M->Sizes.numBlocks = (69);   /* Number of blocks */
