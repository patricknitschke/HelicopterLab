...
MODEL                = heli_q8_d3p2
MODULES              = heli_q8_d3p2_data.c heli_q8_d3p2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_d3p2.mk
...
MODELLIB                  = heli_q8_d3p2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_d3p2_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\jahnpn\Desktop\LINSYS~1\PROJEC~1\MatLab\Dag3
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_d3p2_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Dag3_2
