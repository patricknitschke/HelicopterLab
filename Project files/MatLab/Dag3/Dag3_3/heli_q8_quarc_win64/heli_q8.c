 ...
 * C source code generated on : Tue Oct 01 16:35:17 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  S-Function (hil_read_encoder_timebase_block): '<S2>/HIL Read Encoder Timebase'
     */
    heli_q8_B.Sum1 = heli_q8_P.PitchCounttorad_Gain *
      rtb_HILReadEncoderTimebase_o2 + heli_q8_P.Constant2_Value;

    /* Sum: '<S2>/Sum2' incorporates:
     *  Constant: '<S2>/Constant1'
     *  Gain: '<S2>/Elevation: Count to rad'
     */
    heli_q8_B.Sum2 = heli_q8_P.ElevationCounttorad_Gain * rtb_DeadZoney +
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_B.Sum1;
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.Joystick_gain_y;
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.Integrator[0];
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.Integrator[1];
     ...
     */
    heli_q8_B.Fr[0] = 0.0;
    heli_q8_B.Fr[0] += heli_q8_P.F[0] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Fr[0] += heli_q8_P.F[2] * heli_q8_B.Joystick_gain_y;
    heli_q8_B.Fr[1] = 0.0;
    heli_q8_B.Fr[1] += heli_q8_P.F[1] * heli_q8_B.Joystick_gain_x;
  ...
  heli_q8_B.PitchTransferFcn += heli_q8_P.PitchTransferFcn_D * heli_q8_B.Sum1;

  /* SignalConversion: '<S5>/TmpSignal ConversionAtK*xInport1' */
  tmp[0] = heli_q8_B.Sum1;
  tmp[1] = heli_q8_B.PitchTransferFcn;
  tmp[2] = heli_q8_B.ElevationTransferFcn;
  tmp[3] = heli_q8_B.Integrator[0];
  tmp[4] = heli_q8_B.Integrator[1];
  ...
  for (i = 0; i < 2; i++) {
    ...
    heli_q8_B.Sum3[i] = heli_q8_B.Fr[i] - u0;
  }

  /* End of Sum: '<S5>/Sum3' */
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Constant: '<Root>/V_s0' */
    heli_q8_B.V_s0[0] = heli_q8_P.V_s0_Value[0];
    heli_q8_B.V_s0[1] = heli_q8_P.V_s0_Value[1];
  }

  /* Sum: '<Root>/Sum1' */
  heli_q8_B.Sum1_d[0] = heli_q8_B.V_s0[0] + heli_q8_B.Sum3[0];
  heli_q8_B.Sum1_d[1] = heli_q8_B.V_s0[1] + heli_q8_B.Sum3[1];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum1_d[0] - heli_q8_B.Sum1_d[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum1_d[1] + heli_q8_B.Sum1_d[0]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S3>/ l_p' incorporates:
     *  Gain: '<S3>/K_f '
     */
    rtb_l_p = heli_q8_P.K_f * 0.0 * heli_q8_P.l_p;
  }

  /* Sum: '<Root>/Sum2' */
  heli_q8_B.Sum2_k[0] = heli_q8_B.Sum1 - heli_q8_B.Joystick_gain_x;
  heli_q8_B.Sum2_k[1] = heli_q8_B.ElevationTransferFcn -
   ...
   */
  heli_q8_B.uJ_l = heli_q8_P.K_f * heli_q8_X.Integrator_CSTATE_k * heli_q8_P.l_h
    * heli_q8_P.V_s0 * (1.0 / heli_q8_P.J_l);
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S3>/1//J_p' */
    heli_q8_B.uJ_p = 1.0 / heli_q8_P.J_p * rtb_l_p;
     ...
     *  Sum: '<S3>/Sum1'
     */
    heli_q8_B.uJ_e = (0.0 - heli_q8_P.V_s0) * heli_q8_P.K_f * heli_q8_P.l_h *
      (1.0 / heli_q8_P.J_p);
  }
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->ElevationTransferFcn_CSTATE += heli_q8_P.ElevationTransferFcn_A *
    heli_q8_X.ElevationTransferFcn_CSTATE;
  _rtXdot->ElevationTransferFcn_CSTATE += heli_q8_B.Sum2;

  /* Derivatives for Integrator: '<Root>/Integrator' */
  _rtXdot->Integrator_CSTATE[0] = heli_q8_B.Sum2_k[0];
  _rtXdot->Integrator_CSTATE[1] = heli_q8_B.Sum2_k[1];

  /* Derivatives for TransferFcn: '<S2>/Pitch: Transfer Fcn' */
  _rtXdot->PitchTransferFcn_CSTATE = 0.0;
  _rtXdot->PitchTransferFcn_CSTATE += heli_q8_P.PitchTransferFcn_A *
    heli_q8_X.PitchTransferFcn_CSTATE;
  _rtXdot->PitchTransferFcn_CSTATE += heli_q8_B.Sum1;
  ...
  _rtXdot->Integrator_CSTATE_k = heli_q8_B.Integrator1;

  /* Derivatives for Integrator: '<S3>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = heli_q8_B.uJ_p;

  /* Derivatives for Integrator: '<S3>/Integrator4' */
  _rtXdot->Integrator4_CSTATE = heli_q8_B.Integrator5;

  /* Derivatives for Integrator: '<S3>/Integrator5' */
  _rtXdot->Integrator5_CSTATE = heli_q8_B.uJ_l;

  /* Derivatives for Integrator: '<S3>/Integrator2' */
  _rtXdot->Integrator2_CSTATE = heli_q8_B.Integrator3;

  /* Derivatives for Integrator: '<S3>/Integrator3' */
  _rtXdot->Integrator3_CSTATE = heli_q8_B.uJ_e;
}
...
void heli_q8_initialize(void)
{
  ...
  /* Start for ToFile: '<Root>/To File' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file Day3Part3.mat");
      return;
    }
  ...
  heli_q8_X.Integrator_CSTATE_k = heli_q8_P.Integrator_IC_n;
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "Day3Part3.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file Day3Part3.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file Day3Part3.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, heli_q8_DW.ToFile_IWORK.Count, "ans")) {
        rtmSetErrorStatus(heli_q8_M,
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3971701611U);
  heli_q8_M->Sizes.checksums[1] = (757842921U);
  heli_q8_M->Sizes.checksums[2] = (3096635423U);
  heli_q8_M->Sizes.checksums[3] = (3110897921U);
...

  {
    ...
    heli_q8_B.V_s0[0] = 0.0;
    heli_q8_B.V_s0[1] = 0.0;
    heli_q8_B.Sum1_d[0] = 0.0;
    heli_q8_B.Sum1_d[1] = 0.0;
    heli_q8_B.TravelTransferFcn = 0.0;
    ...
    heli_q8_B.Sum2_k[0] = 0.0;
    heli_q8_B.Sum2_k[1] = 0.0;
    heli_q8_B.uJ_l = 0.0;
    heli_q8_B.uJ_p = 0.0;
  ...
  heli_q8_M->Sizes.numBlockPrms = (166);/* Sum of parameter "widths" */
  return heli_q8_M;
}
