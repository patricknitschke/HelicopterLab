...
typedef struct {
  ...
  real_T Integrator_CSTATE_k;          /* '<S3>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_k;       /* '<S3>/Integrator' */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Heli. Model'
 * '<S4>'   : 'heli_q8/Joystick'
 * '<S5>'   : 'heli_q8/Pitch & Elevator controller'
 * '<S6>'   : 'heli_q8/Pitch & Elevator controller/Pitch PD-controller'
 */
