...
typedef struct {
  ...
  real_T Integrategammazeta_CSTATE[2]; /* '<S4>/Integrate -> [gamma,zeta]' */
...
typedef struct {
  ...
  boolean_T Integrategammazeta_CSTATE[2];/* '<S4>/Integrate -> [gamma,zeta]' */
...
struct P_heli_q8_d3p3_T_ {
  ...
  real_T p_c1_Time;                    /* Expression: 5
                                        ...
                                        */
  real_T p_c1_Y0;                      /* Expression: -0.2
                                        * Referenced by: '<S3>/p_c1'
                                        */
  real_T p_c1_YFinal;                  /* Expression: 0.4
                                        * Referenced by: '<S3>/p_c1'
                                        */
  ...
  real_T Integrategammazeta_IC;        /* Expression: 0
                                        * Referenced by: '<S4>/Integrate -> [gamma,zeta]'
                                        */
 ...
 * '<S2>'   : 'heli_q8_d3p3/Heli 3D'
 * '<S3>'   : 'heli_q8_d3p3/Joystick'
 * '<S4>'   : 'heli_q8_d3p3/Pitch & Elevation Controller'
 * '<S5>'   : 'heli_q8_d3p3/Pitch & Elevation Controller/LQR'
 */
