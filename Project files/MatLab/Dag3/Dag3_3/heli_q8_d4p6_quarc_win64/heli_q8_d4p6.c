 ...
 * C source code generated on : Sun Nov 17 16:49:39 2019
 *
...
void heli_q8_d4p6_output0(void)        /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_TmpSignalConversionAtMeasur[5];
  ...
  if (rtmIsMajorTimeStep(heli_q8_d4p6_M)) {
    ...
    heli_q8_d4p6_B.Sum1 = heli_q8_d4p6_P.PitchCounttorad_Gain *
      rtb_FrontmotorSaturation + heli_q8_d4p6_P.Constant2_Value_f;
    ...
    for (i = 0; i < 3; i++) {
      ...
      /* SignalConversion: '<Root>/TmpSignal ConversionAtMeasurement noiseInport1' */
      rtb_TmpSignalConversionAtMeasur[i] = heli_q8_d4p6_B.euler_rates[i];
    }
    ...
    /* SignalConversion: '<Root>/TmpSignal ConversionAtMeasurement noiseInport1' */
    rtb_TmpSignalConversionAtMeasur[3] = heli_q8_d4p6_B.TrigonometricFunction;
    rtb_TmpSignalConversionAtMeasur[4] = heli_q8_d4p6_B.TrigonometricFunction1;

    /* ToFile: '<Root>/Measurement noise' */
    if (rtmIsMajorTimeStep(heli_q8_d4p6_M)) {
      {
        if (!(++heli_q8_d4p6_DW.Measurementnoise_IWORK.Decimation % 1) &&
            (heli_q8_d4p6_DW.Measurementnoise_IWORK.Count*6)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (((++heli_q8_d4p6_DW.Measurementnoise_IWORK.Count)*6)+1 >=
                100000000) {
              (void)fprintf(stdout,
  ...
  if (rtmIsMajorTimeStep(heli_q8_d4p6_M)) {
     ...
     *  Sum: '<S1>/Subtract'
     */
    rtb_DeadZoney = heli_q8_d4p6_P.Backgain_Gain * 0.0;

    /* Gain: '<S1>/Front gain' incorporates:
     *  Sum: '<S1>/Add'
     */
    rtb_FrontmotorSaturation = heli_q8_d4p6_P.Frontgain_Gain * 0.0;

    /* Saturate: '<S2>/Front motor: Saturation' */
    if (rtb_FrontmotorSaturation > heli_q8_d4p6_P.FrontmotorSaturation_UpperSat)
    {
      rtb_FrontmotorSaturation = heli_q8_d4p6_P.FrontmotorSaturation_UpperSat;
    } else {
      if (rtb_FrontmotorSaturation <
          heli_q8_d4p6_P.FrontmotorSaturation_LowerSat) {
        rtb_FrontmotorSaturation = heli_q8_d4p6_P.FrontmotorSaturation_LowerSat;
      }
    }
    ...
    if (rtb_DeadZoney > heli_q8_d4p6_P.BackmotorSaturation_UpperSat) {
      rtb_DeadZoney = heli_q8_d4p6_P.BackmotorSaturation_UpperSat;
    } else {
      if (rtb_DeadZoney < heli_q8_d4p6_P.BackmotorSaturation_LowerSat) {
        rtb_DeadZoney = heli_q8_d4p6_P.BackmotorSaturation_LowerSat;
      }
    }
    ...
    {
      t_error result;
      heli_q8_d4p6_DW.HILWriteAnalog_Buffer[0] = rtb_FrontmotorSaturation;
      heli_q8_d4p6_DW.HILWriteAnalog_Buffer[1] = rtb_DeadZoney;
    ...
    /* Sum: '<S5>/Sum3' */
    heli_q8_d4p6_B.Sum3[0] = heli_q8_d4p6_B.TrigonometricFunction -
      heli_q8_d4p6_B.Joystick_gain_x;
    heli_q8_d4p6_B.Sum3[1] = heli_q8_d4p6_B.euler_rates[1] -
...
void heli_q8_d4p6_initialize(void)
{
  ...
  /* Start for ToFile: '<Root>/Measurement noise' */
  {
    FILE *fp = (NULL);
    char fileName[509] = "noise.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_d4p6_M, "Error creating .mat file noise.mat");
      return;
    }
...
void heli_q8_d4p6_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/Measurement noise' */
  {
    FILE *fp = (FILE *) heli_q8_d4p6_DW.Measurementnoise_PWORK.FilePtr;
    if (fp != (NULL)) {
      char fileName[509] = "noise.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_d4p6_M, "Error closing MAT-file noise.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_d4p6_M, "Error reopening MAT-file noise.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 6,
           heli_q8_d4p6_DW.Measurementnoise_IWORK.Count, "noise")) {
        rtmSetErrorStatus(heli_q8_d4p6_M,
...
RT_MODEL_heli_q8_d4p6_T *heli_q8_d4p6(void)
{
  ...
  /* External mode info */
  heli_q8_d4p6_M->Sizes.checksums[0] = (3652478773U);
  heli_q8_d4p6_M->Sizes.checksums[1] = (1793146385U);
  heli_q8_d4p6_M->Sizes.checksums[2] = (91624329U);
  heli_q8_d4p6_M->Sizes.checksums[3] = (1443466772U);
  ...
  heli_q8_d4p6_M->Sizes.numBlocks = (75);/* Number of blocks */
  heli_q8_d4p6_M->Sizes.numBlockIO = (18);/* Number of block outputs */
  heli_q8_d4p6_M->Sizes.numBlockPrms = (419);/* Sum of parameter "widths" */
