...
MODEL                = heli_q8_d1p3
MODULES              = heli_q8_d1p3_data.c heli_q8_d1p3_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_d1p3.mk
...
MODELLIB                  = heli_q8_d1p3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_d1p3_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\jahnpn\Desktop\HELICO~1\PROJEC~1\MatLab\Dag1\Dag1p3
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_d1p3_quarc_win64
