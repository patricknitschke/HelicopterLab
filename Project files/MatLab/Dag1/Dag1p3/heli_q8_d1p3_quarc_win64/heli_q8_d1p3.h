...
#ifndef RTW_HEADER_heli_q8_d1p3_h_
#define RTW_HEADER_heli_q8_d1p3_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_d1p3_COMMON_INCLUDES_
# define heli_q8_d1p3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_d1p3_COMMON_INCLUDES_ */

#include "heli_q8_d1p3_types.h"
...
#define heli_q8_d1p3_rtModel           RT_MODEL_heli_q8_d1p3_T
...
typedef struct {
  ...
  real_T Integrator4;                  /* '<S3>/Integrator4' */
  ...
  real_T V_s0_b;                       /* '<S3>/V_s0' */
  real_T uJ_e;                         /* '<S3>/1//J_e' */
  real_T uJ_l;                         /* '<S3>/1//J_l' */
  real_T uJ_p;                         /* '<S3>/1//J_p' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } lambda_PWORK;                      /* '<S6>/lambda' */

  struct {
    void *LoggedData[2];
  } lambdadot_PWORK;                   /* '<S6>/lambdadot' */
...
#define rtB                            heli_q8_d1p3_B
#define BlockIO                        B_heli_q8_d1p3_T
#define rtX                            heli_q8_d1p3_X
#define ContinuousStates               X_heli_q8_d1p3_T
#define rtXdot                         heli_q8_d1p3_XDot
#define StateDerivatives               XDot_heli_q8_d1p3_T
#define tXdis                          heli_q8_d1p3_XDis
#define StateDisabled                  XDis_heli_q8_d1p3_T
#define rtP                            heli_q8_d1p3_P
#define Parameters                     P_heli_q8_d1p3_T
#define rtDWork                        heli_q8_d1p3_DW
#define D_Work                         DW_heli_q8_d1p3_T

/* Parameters (auto storage) */
struct P_heli_q8_d1p3_T_ {
  real_T J_l;                          /* Variable: J_l
                                        * Referenced by: '<S3>/1//J_l'
                                        */
...
extern P_heli_q8_d1p3_T heli_q8_d1p3_P;

/* Block signals (auto storage) */
extern B_heli_q8_d1p3_T heli_q8_d1p3_B;

/* Continuous states (auto storage) */
extern X_heli_q8_d1p3_T heli_q8_d1p3_X;

/* Block states (auto storage) */
extern DW_heli_q8_d1p3_T heli_q8_d1p3_DW;
...
extern void heli_q8_d1p3_initialize(void);
extern void heli_q8_d1p3_output0(void);
extern void heli_q8_d1p3_update0(void);
extern void heli_q8_d1p3_output(int_T tid);
extern void heli_q8_d1p3_update(int_T tid);
extern void heli_q8_d1p3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_d1p3_rtModel *heli_q8_d1p3(void);
...
extern RT_MODEL_heli_q8_d1p3_T *const heli_q8_d1p3_M;
 ...
 *
 * '<Root>' : 'heli_q8_d1p3'
 * '<S1>'   : 'heli_q8_d1p3/Conversion'
 * '<S2>'   : 'heli_q8_d1p3/Heli 3D'
 * '<S3>'   : 'heli_q8_d1p3/Heli. Model'
 * '<S4>'   : 'heli_q8_d1p3/Joystick'
 * '<S5>'   : 'heli_q8_d1p3/Pitch & Elevator controller'
 * '<S6>'   : 'heli_q8_d1p3/Scope system'
 * '<S7>'   : 'heli_q8_d1p3/Pitch & Elevator controller/Pitch PD-controller'
 */
#endif                                 /* RTW_HEADER_heli_q8_d1p3_h_ */
